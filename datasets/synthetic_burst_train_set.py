...
class SyntheticBurst(torch.utils.data.Dataset):
    ...
    """
    def __init__(self, base_dataset, burst_size=8, crop_sz=384, transform=tfm.ToTensor(), phase='train', scale_factor=4):
        ...
        self.burst_transformation_params = {'max_translation': 8.0,
                                            'max_rotation': 1.0,
                                            'max_shear': 0.0,
                                            'max_scale': 0.0,
                                            'border_crop': 8}
    ...
    def __getitem__(self, index):
        ...
        target_size = (frame_gt.shape[1]//2, frame_gt.shape[2]//2)
        return burst, frame_gt, flow_vectors, meta_info, self.downsample_factor, target_size
